...
public class T01FileTest {
	public static void main(String[] args) throws IOException { //getCanonicalPath의 예외발생
		// File객체 만들기 연습
		...
		File file4 = new File(".\\D_Other\\test\\..", "test.txt"); // 상대경로(. 이나 ..으로 시작함)
		...
		2. mkdirs() => 중간의 경로가 없으면 중간으 경로도 새롭게 만든 후 마지막
					   위치의 디렉토리를 만들어 준다.
					   
			=> 위 두 메서드 모두 만들기를 성공하면 true, 실패하면 false를 반환함.
	 */
	File file5 = new File("d:/D_Other/연습용");
	// 파일 생성.. 동일이름('연습용')파일이 없어야 실행됨.
	if(file5.mkdir()) {
