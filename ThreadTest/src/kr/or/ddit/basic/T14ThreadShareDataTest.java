...
class CalcPIThread extends Thread {
	 ...
	 */
		double sum = 0.0;
		for(int i=1; i<=1500000; i+=2) { //i<=1500000; 크기에 따라 정밀도 차이가 생긴다.
		...
		sd.isOk = true;     // 계산이 완료되었음을 나타낸다. (중지하기 위해)
	}
}
...
class PrintPIThread extends Thread {
	...
	public void run() {
		...
		System.out.println();
		System.err.println("계산된 원주율 : " + sd.result);
